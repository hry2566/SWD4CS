...
namespace SWD4CS
{
    public partial class cls_tabcontrol : TabControl
    {
        ...
        internal bool changeFlag = false;
        private Point memPos;
        private int grid = 8;

        public cls_tabcontrol(cls_form form, Control parent, Control backPanel, ListBox toolList, DataGridView propertyList, int index, int X = 0, int Y = 0)
        {
            ...
            parent.Controls.Add(this.form.CtrlItems[this.form.CtrlItems.Count - 1] as cls_tabcontrol);
        ...
        internal void ControlMouseDown(object? sender, MouseEventArgs e)
        {
        ...
        internal void ControlMouseMove(object? sender, MouseEventArgs e)
        {
            if (e.Button == MouseButtons.Left && selectFlag)
            {
